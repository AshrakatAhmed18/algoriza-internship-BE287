...
namespace Vezeeta.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
       ...
       private readonly IAdminDashboardService _adminDashbordService;
        ...
        {
             var DocNumber=  _adminDashbordService.NumOfDoctors();
            return Ok(DocNumber);
        }
        [HttpGet]
        [Route("NumOfPatients")]
        ...
        {
             var PatiensNum= _adminDashbordService.NumOfPatients();
        ...
        public IActionResult GetAllDoctor()
        {
           ...
           var Doc = _adminDoctorService.GetDoctorDetails();
            return Ok(Doc);
        ...
        public IActionResult GetAllPatients()
        {
            ...
            var Patients = _adminPatientService.GetPatientDetails();
            return Ok(Patients);
