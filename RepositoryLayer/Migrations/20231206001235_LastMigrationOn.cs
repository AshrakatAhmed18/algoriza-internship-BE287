...
{
    public partial class LastMigrationOn : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TimeInHour = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Times_TimetableID",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ded33e53-ad9c-4fdd-a035-41dc6a68c639", "Admin", null },
                    { 2, "5a225ecf-6afd-4232-963b-3a4a9ca1c048", "Doctor", null },
                    { 3, "d685341f-801d-4c46-acc2-6cd4c82a48c8", "Patient", null }
                });
